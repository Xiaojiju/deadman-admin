...
/**
 * 用户端微信 OAuth 绑定登录 Provider：校验用户名密码并将 openid 绑定到用户端用户。
 */
@Component
@RequiredArgsConstructor
public class ClientWechatBindLoginProvider implements LoginProvider {

    /** 绑定登录路径 */
    public static final String BIND_LOGIN_ENDPOINT = "/client/api/auth/wechat-miniprogram/bind";
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        return clientWechatAuthService.bindAndAuthenticate(
