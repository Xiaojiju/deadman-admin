...
/**
 * 管理端微信小程序登录 Provider，覆盖插件默认实现：未绑定时返回待绑定临时令牌而非自动开通用户。
 */
@RequiredArgsConstructor
public class AdminWechatMiniprogramLoginProvider implements LoginProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        return adminWechatAuthService.loginByWechatCode(code);
    }
