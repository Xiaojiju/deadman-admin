...
/**
 * 按绑定配置实例化的微信网页扫码登录 Provider，同一插件可同时服务多个用户体系组。
 */
@RequiredArgsConstructor
public class ConfiguredWechatWebLoginProvider implements LoginProvider {

    private final WechatWebLoginBinding binding;
    private final WechatWebAuthService authService;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        return authService.authenticate(code, state, loginGroupId());
    }
